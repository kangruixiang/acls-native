import{P as I,x as H,B as b}from"../chunks/index.vQOh5x6P.js";import"../chunks/disclose-version.15-3dQtY.js";import{c as F,p as $}from"../chunks/runtime.w64avLmG.js";import{z as V,b as C,d as U,f as g,s as p,h as W,o as w,l as k}from"../chunks/render.fVPzZyBR.js";import{g as j}from"../chunks/navigation.Pyas3pEi.js";import{_ as G}from"../chunks/preload-helper.0HuHagjb.js";async function X({params:e}){const r=e.slug;return{record:await I.get({key:r})}}const Re=Object.freeze(Object.defineProperty({__proto__:null,load:X},Symbol.toStringTag,{value:"Module"}));H("Share",{web:()=>G(()=>import("../chunks/web.gTeAajum.js"),__vite__mapDeps([0,1,2,3,4,5,6,7,8]),import.meta.url).then(e=>new e.ShareWeb)});function z(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)t.hasOwnProperty(n)&&(e[n]=t[n])}return e}function N(e,r){return Array(r+1).join(e)}function K(e){return e.replace(/^\n*/,"")}function Y(e){for(var r=e.length;r>0&&e[r-1]===`
...
`:t}};this.options=z({},r,e),this.rules=new x(this.options)}m.prototype={turndown:function(e){if(!ve(e))throw new TypeError(e+" is not a string, or an element/document/fragment node.");if(e==="")return"";var r=L.call(this,new le(e,this.options));return me.call(this,r)},use:function(e){if(Array.isArray(e))for(var r=0;r<e.length;r++)this.use(e[r]);else if(typeof e=="function")e(this);else throw new TypeError("plugin must be a Function or an Array of Functions");return this},addRule:function(e,r){return this.rules.add(e,r),this},keep:function(e){return this.rules.keep(e),this},remove:function(e){return this.rules.remove(e),this},escape:function(e){return he.reduce(function(r,t){return r.replace(t[0],t[1])},e)}};function L(e){var r=this;return pe.call(e.childNodes,function(t,n){n=new ue(n,r.options);var i="";return n.nodeType===3?i=n.isCode?n.nodeValue:r.escape(n.nodeValue):n.nodeType===1&&(i=ge.call(r,n)),M(t,i)},"")}function me(e){var r=this;return this.rules.forEach(function(t){typeof t.append=="function"&&(e=M(e,t.append(r.options)))}),e.replace(/^[\t\r\n]+/,"").replace(/[\t\r\n\s]+$/,"")}function ge(e){var r=this.rules.forNode(e),t=L.call(this,e),n=e.flankingWhitespace;return(n.leading||n.trailing)&&(t=t.trim()),n.leading+r.replacement(t,e,this.options)+n.trailing}function M(e,r){var t=Y(e),n=K(r),i=Math.max(e.length-t.length,r.length-n.length),a=`

`.substring(0,i);return t+a+n}function ve(e){return e!=null&&(typeof e=="string"||e.nodeType&&(e.nodeType===1||e.nodeType===9||e.nodeType===11))}var ye=k("Copy",!0),Ae=k("Back to Previous Codes",!0),Ne=k('<div class="flex h-full flex-col gap-10 overflow-y-auto px-4 py-8"><div><!></div> <div class="flex flex-col gap-2"><!> <!></div></div>');function Se(e,r){$(r,!0);async function t(){const c=new m({bulletListMarker:"-"}).turndown(r.data.record.value);await navigator.clipboard.writeText(c)}var n=W(e,!0,Ne),i=g(n),a=g(i);V(a,()=>r.data.record.value,!1);var o=p(p(i)),f=g(o),l=p(p(f));b(f,{$$events:{click:t},children:(s,c)=>{var d=w(s,!0,ye);C(s,d)}}),b(l,{$$events:{click:()=>{j("/recordList")}},children:(s,c)=>{var d=w(s,!0,Ae);C(s,d)}}),U(e,n),F()}export{Se as component,Re as universal};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["../chunks/web.gTeAajum.js","../chunks/index.vQOh5x6P.js","../chunks/preload-helper.0HuHagjb.js","../chunks/disclose-version.15-3dQtY.js","../chunks/runtime.w64avLmG.js","../chunks/render.fVPzZyBR.js","../chunks/index.zUa3ZUDx.js","../chunks/singletons.qi_OFHbd.js","../chunks/main-client.pYAxlQny.js"]
  }
